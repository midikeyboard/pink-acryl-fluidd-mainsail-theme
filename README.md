# pink-acryl-fluidd-mainsail-theme
...
```bash
git clone https://github.com/midikeyboard/pink-acryl-fluidd-mainsail-theme ~/printer_data/config/.theme
```

## Installation Fluidd
```bash
git clone https://github.com/midikeyboard/pink-acryl-fluidd-mainsail-theme ~/printer_data/config/.fluidd-theme
```
